...
const CropDetails = () => {
  ...
  const handlePrev = () => {
    ...
    setCurrentIndex(prev =>
      prev === 0 ? crop.images.length - 1 : prev - 1
    );
  };
  ...
  const handleNext = () => {
    if (!crop?.images?.length) return;
    setCurrentIndex(prev =>
      prev === crop.images.length - 1 ? 0 : prev + 1
    );
  };
  ...
  const handleDelete = async () => {
    if (window.confirm("Are you sure you want to delete this crop listing?")) {
      try {
        ...
        await axios.delete(`http://localhost:5000/api/crops/${crop._id}`, {
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 items-start pt-10">
          ...
          <div className="relative h-64 sm:h-80 md:h-96 bg-[#212529]">
            {crop.images && crop.images.length > 0 ? (
              <>
               ...
               : `http://localhost:5000${crop.images[currentIndex]}`
           }
            alt="crop"
        ...
        <div className="space-y-5 lg:sticky lg:top-24 h-fit">
          ...
          <div className="bg-white rounded-xl shadow-md p-5">
            <h3 className="font-semibold mb-3 text-green-700">Farmer Information</h3>
            <p>{crop.firstName} {crop.lastName}</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-3">
                <div className="bg-green-50 p-3 rounded-lg">
                  <p className="text-sm text-gray-600">Predicted Market Price</p>
